...
Plans:
- [ ] 69-01-PLAN.md — Disable automatic leveling and modify XP thresholds
- [ ] 69-02-PLAN.md — UseEntityCallback for manual level up with stage gates
...
Plans:
- [ ] 70-01-PLAN.md — Trade cycling via UseEntityCallback (0 XP reroll with pool size check)
