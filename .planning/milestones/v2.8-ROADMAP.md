...
Plans:
- [ ] 67-01-PLAN.md — AllowedProfessions helper + VillagerProfessionMixin (data layer restriction)
- [ ] 67-02-PLAN.md — ServerLevelPoiMixin extension (world layer POI blocking)
...
Plans:
- [ ] 68-01-PLAN.md — CustomTradeTables foundation + VillagerTradesMixin interception
- [ ] 68-02-PLAN.md — Librarian trades (enchanted books with 50/50 variants)
- [ ] 68-03-PLAN.md — Butcher, Mason, Cartographer trades (structure locators)
