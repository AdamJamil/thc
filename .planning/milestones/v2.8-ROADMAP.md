...
- [ ] **Phase 66: Structure Locators** - Custom compass-style items pointing to structures
- [ ] **Phase 67: Job Restriction** - Limit villagers to 4 allowed professions
- [ ] **Phase 68: Custom Trade Tables** - Deterministic trades for all 4 professions
- [ ] **Phase 69: Manual Leveling** - Stage-gated emerald advancement
- [ ] **Phase 70: Trade Cycling** - Reroll current rank trades with emerald
...
Plans:
- [ ] 66-01-PLAN.md — StructureLocatorItem base class + 6 item registrations
- [ ] 66-02-PLAN.md — Item model definitions, 96 directional models/textures, lang entries
...
Plans:
- [ ] 67-01: POI blocking for disallowed job blocks
- [ ] 67-02: Profession assignment restriction at setVillagerData
...
Plans:
- [ ] 68-01: Trade table data structures and registration
- [ ] 68-02: Librarian trade implementation
- [ ] 68-03: Butcher, Mason, Cartographer trade implementation
...
**Success Criteria** (what must be TRUE):
  ...
  2. Shift+right-click with emerald at max XP triggers level up
...
Plans:
- [ ] 69-01: Disable automatic leveling and modify XP thresholds
- [ ] 69-02: UseEntityCallback for manual level up with stage gates
...
Plans:
- [ ] 70-01: Trade cycling via UseEntityCallback
...
Plans:
- [ ] 71-01: Rail recipe modifications
...
|-------|----------------|--------|-----------|
| 66. Structure Locators | 0/2 | Planned | - |
| 67. Job Restriction | 0/2 | Not started | - |
| 68. Custom Trade Tables | 0/3 | Not started | - |
| 69. Manual Leveling | 0/2 | Not started | - |
| 70. Trade Cycling | 0/1 | Not started | - |
