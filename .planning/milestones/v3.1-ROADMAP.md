...
**Status:** Active
**Phases:** 75-79
**Total Plans:** 2+ (Phases 75-76 planned)
...
Plans:
- [ ] 75-01-PLAN.md — Rename TANK enum to BASTION, update command suggestion
...
**Expected Plans:**
- Phase 75: 1 plan (rename is atomic)
- Phase 76: 1 plan (buckler gate)
- Phase 77: 1-2 plans (parry aggro + sweeping may be separate)
- Phase 78: 1 plan (snowball enhancement)
- Phase 79: 2-3 plans (land placement, mob trapping, recipe/stack changes)
