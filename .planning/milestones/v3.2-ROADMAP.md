...
Plans:
- [x] 80-01-PLAN.md — Effects HUD renderer with priority sorting and frame+icon layout ✓
...
Plans:
- [x] 81-01-PLAN.md — Duration overlay and roman numeral rendering ✓
...
Plans:
- [x] 82-01-PLAN.md — Config + Video Settings mixin for Effects GUI scaling slider ✓
