...
- [ ] **Phase 83: Health Bar Rendering** - Three-layer floating health bar above hostile mobs with visibility gating
- [ ] **Phase 84: Mob Effects Display** - Status effect icons rendered above health bar using effects GUI style
- [ ] **Phase 85: Scaling** - Video Settings slider controlling health bar and effect icon sizes
