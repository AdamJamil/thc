 ...
 *
 * <p>Fabric implements this on {@link class_1297}, {@link class_2586}, {@link class_3218} and {@link class_2791} via mixin.</p>
 *
 * <p>Note about {@link class_2586} and {@link class_2791} targets: these objects need to be notified of changes to their
 * state (using {@link class_2586#method_5431()} and {@link class_2791#method_65063()} respectively), otherwise the modifications will not take effect properly.
 ...
 *
 * <p>
 * Note about {@link class_2586} targets: by default, many block entities use their NBT to synchronize with the client.
 * That would mean persistent attachments are automatically synced with the client for those block entities. As this is
 * undesirable behavior, the API completely removes attachments from the result of {@link class_2586#method_16887},
 ...
 *
 * <p>
 * Note about {@link class_2791} targets with {@link class_2806#field_12798}: These chunks are not saved unless the generation
 * progresses to at least {@link class_2806#field_16423}. Therefore, persistent attachments to those chunks may not
