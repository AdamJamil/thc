...
public class AttachmentSerializingImpl {
	...
	private static final Codec<AttachmentType<?>> TYPE_CODEC = class_2960.field_25139.comapFlatMap(id -> {
	...
	public static void serializeAttachmentData(class_11372 view, @Nullable IdentityHashMap<AttachmentType<?>, Object> attachments) {
		...
		view.method_71468(AttachmentTarget.NBT_ATTACHMENT_KEY, CODEC, attachmentsToSerialize);
	}

	@Nullable
	public static IdentityHashMap<AttachmentType<?>, Object> deserializeAttachmentData(@Nullable class_11368 data) {
		return data == null ? null : data.method_71426(AttachmentTarget.NBT_ATTACHMENT_KEY, CODEC).filter(m -> !m.isEmpty()).orElse(null);
	}
