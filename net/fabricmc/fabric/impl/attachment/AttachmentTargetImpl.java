...
public interface AttachmentTargetImpl extends AttachmentTarget {
	...
	default void fabric_writeAttachmentsToNbt(class_11372 view) {
		throw new UnsupportedOperationException("Implemented via mixin");
	}

	default void fabric_readAttachmentsFromNbt(class_11368 view) {
		throw new UnsupportedOperationException("Implemented via mixin");
	}
	 ...
	 */
	default void fabric_computeInitialSyncChanges(class_3222 player, Consumer<AttachmentChange> changeOutput) {
		throw new UnsupportedOperationException("Implemented via mixin");
	}
